...
namespace TrueCrypt
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// Class DaPlugDialogBase
    ///////////////////////////////////////////////////////////////////////////////
    class DaPlugDialogBase : public wxDialog
    {
        private:
        ...
        public:
            DaPlugDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("DaPlug data"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE );
            ~DaPlugDialogBase();
	...
	class VolumePasswordPanelBase : public wxPanel 
	{
		...
		protected:
			...
			wxCheckBox* UseKeyfilesCheckBox;
            wxCheckBox* UseDaPlugCheckBox; /*[XaV]*/
			wxButton* KeyfilesButton;
            wxButton* DaPlugButton; /*[XaV]*/
            ...
            virtual void OnDaPlugButtonClick( wxCommandEvent& event ){ event.Skip(); } /*[XaV]*/
            virtual void OnUseDaPlugCheckBoxClick( wxCommandEvent& event ){ event.Skip(); } /*[XaV]*/
