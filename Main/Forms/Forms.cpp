...
DaPlugDialogBase::DaPlugDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style ) /*[XaV]*/
{
    this->SetSizeHints( wxDefaultSize, wxDefaultSize );
    this->SetExtraStyle( wxWS_EX_VALIDATE_RECURSIVELY );
...
DaPlugDialogBase::~DaPlugDialogBase() /*[XaV]*/
{
    // Disconnect Events
...
VolumePasswordPanelBase::VolumePasswordPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
    ...
    UseDaPlugCheckBox = new wxCheckBox( this, wxID_ANY, _("Use D&aPlug"), wxDefaultPosition, wxDefaultSize, 0 ); /*[XaV]*/
    GridBagSizer->Add( UseDaPlugCheckBox, wxGBPosition( 6, 1 ), wxGBSpan( 1, 1 ), wxTOP|wxRIGHT|wxLEFT, 5 );

    DaPlugButton = new wxButton( this, wxID_ANY, _("C&heck DaPlug"), wxDefaultPosition, wxDefaultSize, 0 );
    GridBagSizer->Add( DaPlugButton, wxGBPosition( 6, 2 ), wxGBSpan( 1, 1 ), wxALIGN_RIGHT|wxALIGN_BOTTOM|wxLEFT, 5 );
    ...
    UseDaPlugCheckBox->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( VolumePasswordPanelBase::OnUseDaPlugCheckBoxClick ), NULL, this ); /*[XaV]*/
    DaPlugButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VolumePasswordPanelBase::OnDaPlugButtonClick ), NULL, this ); /*[XaV]*/
...
VolumePasswordPanelBase::~VolumePasswordPanelBase()
{
    ...
    DaPlugButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VolumePasswordPanelBase::OnDaPlugButtonClick ), NULL, this ); /*[XaV]*/
