...
namespace TrueCrypt
{
    ...
    {
	public:
        VolumePasswordPanel (wxWindow* parent, shared_ptr <VolumePassword> password, shared_ptr <KeyfileList> keyfiles, bool enableCache = false, bool enablePassword = true, bool enableKeyfiles = true, bool enableConfirmation = false, bool enablePkcs5Prf = false, const wxString &passwordLabel = wxString(), bool enableDaPlug = true);
	...
	protected:
        ...
        shared_ptr <VolumePassword> GetPassword (wxTextCtrl *textCtrl, bool secondFactor) const; /*XaV*/
        ...
        void OnDaPlugButtonClick (wxCommandEvent& event); /*[XaV]*/
        ...
        void OnUseDaPlugCheckBoxClick (wxCommandEvent& event); /*[XaV]*/
		void WipeTextCtrl (wxTextCtrl *textCtrl);

        bool InitializeDaPlug (); /*[XaV]*/

		shared_ptr <KeyfileList> Keyfiles;
		shared_ptr <Functor> UpdateCallback;

        bool DaPlugFound; /*[XaV]*/
        bool needConfirmation; /*[XaV]*/
        wchar_t *DaPlugPassword; /*[XaV]*/
